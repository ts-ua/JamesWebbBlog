...
const AboutSection = () => {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-[url('/Ariane.jpg')] bg-cover bg-center bg-no-repeat px-5 py-20">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 text-center text-white">
        ...
        <Link
          ...
          isExternal
          className="mx-auto flex w-full justify-center rounded-xl border px-8 py-3 uppercase text-white transition-all duration-200 hover:bg-white hover:text-black md:w-fit"
        >
          Assistir
        </Link>
      </div>
