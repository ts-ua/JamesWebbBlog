...
const InfoSection = () => {
  return (
    <section className="w-full bg-neutral-100 p-5 lg:px-0">
      <div className="mx-auto w-full max-w-6xl">
        <Table isStriped aria-label="Visão geral do James Webb">
          ...
          <TableBody>
            ...
            <TableRow key="3">
              ...
              <TableCell className="flex justify-end text-right">Ariane 5</TableCell>
            </TableRow>
            <TableRow key="4">
              <TableCell>MASSA NO LANÇAMENTO</TableCell>
              <TableCell className="flex justify-end text-right">6,200 kg</TableCell>
            </TableRow>
            <TableRow key="5">
            ...
            <TableRow key="9">
              ...
              <TableCell className="flex justify-end text-right">0,6 μm - 28 μm</TableCell>
            </TableRow>
            <TableRow key="10">
        ...
        <p className="m-2 opacity-50 text-sm">Dados: ESA/Webb</p>
        <Divider className="my-8" />

        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          <Card>
            <CardHeader className="flex items-center justify-center">
              <p className="text-webb pt-5 text-xl font-bold">NIRCam</p>
            </CardHeader>
            <CardBody>
          ...
          <Card>
            <CardHeader className="flex items-center justify-center">
              <p className="text-webb pt-5 text-xl font-bold">MIRI</p>
            </CardHeader>
            <CardBody>
              <p className="px-5 pb-5 text-center text-sm font-light">
          ...
          <Card>
            <CardHeader className="flex items-center justify-center">
              <p className="text-webb pt-5 text-xl font-bold">NIRSpec</p>
            </CardHeader>
            <CardBody>
              <p className="px-5 pb-5 text-center text-sm font-light">
        ...
        />
        <p className="m-2 opacity-50 text-sm">Créditos: ESA/ATG medialab.</p>
        <p className="px-5 pb-5 text-center text-sm font-light">
